...
public class GroupsCount extends Command {

  public static class GroupsCountICommand implements ICommandExecutor {

    @Override
    public void execute(final ParseResult result) throws ExecutionException {
      final Object count = JMXUtils.doOperation(GroupManagerDefaultMBean.MBEAN_OBJECT_NAME, "count");
      if (count != null) {
        System.out.println("Groups registered: " + (long) count);
      }
    }
  }
