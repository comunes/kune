...
import cc.kune.kunecli.cmds.SiteReindexAllEntitiesCommand;
import cc.kune.kunecli.cmds.SiteReindexAllWavesCommand;
...
public class KuneCliMain {
  ...
  public static void main(final String[] args)
    ...
    cs.add(injector.getInstance(SiteReindexAllEntitiesCommand.class));
    cs.add(injector.getInstance(SiteReindexAllWavesCommand.class));
