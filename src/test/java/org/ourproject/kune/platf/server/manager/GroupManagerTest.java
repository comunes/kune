...
public class GroupManagerTest extends PersistenceTest {
	...
	Group group = new Group("ysei", "Yellow Submarine Environmental Initiative");
	Group group2 = new Group("ysei", "Yellow Submarine Environmental Initiative 2");
	groupManager.create(user, group);
    ...
    // @Test(expected = SerializableException.class)
    // public void createGroupWithExistingLongName() throws
    // SerializableException {
    // Group group = new Group("ysei", "Yellow Submarine Environmental
    // Initiative");
    // Group group2 = new Group("ysei2", "Yellow Submarine Environmental
    // Initiative");
    // groupManager.create(user, group);
    // groupManager.create(user, group2);
    // rollbackTransaction();
