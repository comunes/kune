...
/**
 * The Class PoPushButtonGui.
 *
 * @author vjrj@ourproject.org (Vicente J. Ruiz Jurado)
 */
public class PoPushButtonGui extends AbstractPoButtonGui {

  /**
   * Instantiates a new gwt push button gui.
   */
  public PoPushButtonGui() {
    super(true);
  }
   ...
   *
   * @see
   * cc.kune.common.client.actions.gwtui.AbstractGwtButtonGui#create(cc.kune
