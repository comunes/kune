...
public abstract class AbstractPoButtonGui extends AbstractPoChildGuiItem implements HasIcon {
   ...
   *          the enable tongle
   */
  public AbstractPoButtonGui(final boolean enableTongle) {
   ...
   */
  public AbstractPoButtonGui(final ButtonDescriptor buttonDescriptor) {
   ...
   *          the enable tongle
   */
  public AbstractPoButtonGui(final ButtonDescriptor buttonDescriptor, final boolean enableTongle) {
  ...
  private FocusWidget castIcon() {
    return (FocusWidget) icon;
  }
  ...
  public void setPressed(final boolean pressed) {
    if (hasText) {
      ...
      ((PaperIconButton) icon).setActive(pressed);
    }
  }
