...
public enum PolymerId implements HTMLId {
  ...
  GROUP_BOTTOMBAR("group_bottombar"),
  ...
  HOME_BOTTOMBAR("home_bottombar"),
  HOME_CENTER("k_home_center"),
  HOME_GLOBAL_STATS("k_home_global_stats"),
  HOME_GROUP_STATS("k_home_group_stats"),
  HOME_SCROLLER("k_home_scroller"),
  HOME_SPACE_ICON("home_space_icon"),
  HOME_TOOLBAR("k_home_toolbar"),
  INBOX_NEW_MESSAGE("inbox_new_message"),
  INBOX_RESULT("inbox_result"),
  INBOX_TUTORIAL("inbox_tutorial"),
