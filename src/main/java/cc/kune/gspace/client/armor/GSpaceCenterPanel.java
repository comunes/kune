...
public class GSpaceCenterPanel extends Composite implements GSpaceCenter {
  ...
  /* (non-Javadoc)
   * @see com.google.gwt.user.client.ui.InsertPanel.ForIsWidget#add(com.google.gwt.user.client.ui.IsWidget)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.google.gwt.user.client.ui.InsertPanel#add(com.google.gwt.user.client.ui.Widget)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see cc.kune.gspace.client.armor.GSpaceCenter#showWidget(com.google.gwt.user.client.ui.IsWidget)
   */
  @Override
