...
public class EditorOfListShareItemDescriptor extends GroupShareItemDescriptor {
  public static class ChangeToAdminAction extends AbstractSetRoleOnListAction {
    @Inject
    ChangeToAdminAction(final Provider<ListsServiceHelper> helper) {
  ...
  public static class ChangeToViewerAction extends AbstractSetRoleOnListAction {
    @Inject
    ChangeToViewerAction(final Provider<ListsServiceHelper> helper) {
  ...
  @Inject
  public EditorOfListShareItemDescriptor(final IconicResources icons,
