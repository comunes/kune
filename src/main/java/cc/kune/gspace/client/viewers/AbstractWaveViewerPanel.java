 ...
 */
public abstract class AbstractWaveViewerPanel implements WaveViewer {
  ...
  /** The only view panel. */
  @UiField
  public InlineHTML onlyViewPanel;
  ...
  protected void initWaveClientIfNeeded() {
    if (channel == null) {
      ...
      waveStore = webClient.getWaveStore();
