...
public class DelTaskMenuItem extends DelContentForEditorsMenuItem {
  ...
  /**
   * Instantiates a new del task menu item.
   * 
   * @param i18n
   *          the i18n
   * @param action
   ...
   */
  @Inject
  public DelTaskMenuItem(final I18nTranslationService i18n, final DelContentForEditorsAction action,
