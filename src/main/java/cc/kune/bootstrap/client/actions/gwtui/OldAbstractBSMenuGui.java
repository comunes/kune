 ...
 */
@Deprecated
public abstract class OldAbstractBSMenuGui extends AbstractBSChildGuiItem implements ParentWidget {
   ...
   *          the descriptor
   */
  public OldAbstractBSMenuGui(final GuiActionDescrip descriptor) {
    super(descriptor);
  }
