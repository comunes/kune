...
public class ListsClientTool extends FoldableAbstractClientTool {
  ...
  public ListsClientTool(final I18nTranslationService i18n, final ToolSelector toolSelector,
    ...
    super(
        TOOL_NAME,
        i18n.t(ROOT_NAME),
        i18n.t("Lists behave similar to a mailing list or a forum (but minimizing emails). You can subscribe and discuss about specific topics."),
  ...
  private void registerIcons() {
    ...
    final String noListNotLogged = i18n.t("There are no lists");
