...
public interface UserService extends RemoteService {
   ...
   * @throws EmailHashInvalidException the email hash invalid exception
   * @throws EmailHashExpiredException the email hash expired exception
   */
   ...
   * @throws GroupLongNameInUseException the group long name in use exception
   */
