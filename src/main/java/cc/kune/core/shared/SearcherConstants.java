...
public final class SearcherConstants {
  ...
  /** The Constant FROM_LANGUAGE_PARAM. */
  ...
  /** The Constant GROUP_DATA_PROXY_URL. */
  ...
  /** The Constant USER_DATA_PROXY_URL. */
  ...
  /**
   * Instantiates a new searcher constants.
   */
