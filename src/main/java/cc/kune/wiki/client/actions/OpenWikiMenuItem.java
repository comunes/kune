...
public class OpenWikiMenuItem extends OpenContentMenuItem {
  ...
  /**
   * Instantiates a new open wiki menu item.
   * 
   * @param i18n
   *          the i18n
   * @param action
   ...
   */
  @Inject
  public OpenWikiMenuItem(final I18nTranslationService i18n, final OpenContentAction action,
