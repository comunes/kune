...
public class DelPostMenuItem extends DelContentForEditorsMenuItem {
  ...
  /**
   * Instantiates a new del post menu item.
   *
   * @param i18n the i18n
   ...
   */
  @Inject
  public DelPostMenuItem(final I18nTranslationService i18n, final DelContentForEditorsAction action,
