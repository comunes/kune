...
public class SimpleRoundedPanel extends ComplexPanel {
	/**
	 ...
	 */
	public SimpleRoundedPanel(Widget w, int corners) {
		super();
		body = DOM.createDiv();
		if (is(corners,TOP)) {
	...
	public SimpleRoundedPanel(Widget w, int corners, String style) {
		this(w, corners);
	 ...
	 * @param w widget to add corners to.
	 */
	public SimpleRoundedPanel(Widget w) {
		this(w, ALL);
	}
	 ...
	 * @param corners set custom rounded corners.
	 */
	public SimpleRoundedPanel(int corners) {
		this(null, corners);
	}
	...
	public void setCornerStyleName(String style) {
        ...
        if(null != divElement) DOM.setAttribute(divElement, "className", style);
	}
    ...
    public void setColor(String color) {
        if(null != div1t) DOM.setStyleAttribute(div1t, "backgroundColor", color);
    	if(null != div1b) DOM.setStyleAttribute(div1b, "backgroundColor", color);
