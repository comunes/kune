...
public class RichTextAreaImplSafari extends RichTextAreaImplStandard {
  ...
  private static final String[] sizeNumberCSSValues = new String[] {
    ...
    public native boolean isBold() /*-{
       return !!this.@org.ourproject.kune.platf.client.ui.rte.impl.RichTextAreaImpl::elem.__gwt_isBold;
     }-*/;
    ...
    public native boolean isItalic() /*-{
       return !!this.@org.ourproject.kune.platf.client.ui.rte.impl.RichTextAreaImpl::elem.__gwt_isItalic;
     }-*/;

    @Override
    public native boolean isUnderlined() /*-{
       return !!this.@org.ourproject.kune.platf.client.ui.rte.impl.RichTextAreaImpl::elem.__gwt_isUnderlined;
     }-*/;
    ...
    protected native String getTextImpl() /*-{
       return this.@org.ourproject.kune.platf.client.ui.rte.impl.RichTextAreaImpl::elem.contentWindow.document.body.innerText;
     }-*/;
    ...
    protected native void setTextImpl(String text) /*-{
       this.@org.ourproject.kune.platf.client.ui.rte.impl.RichTextAreaImpl::elem.contentWindow.document.body.innerText = text;
     }-*/;
