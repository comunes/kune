...
public class WorkspacePanel extends Composite implements WorkspaceView {
	...
	public WorkspacePanel() {
		...
		BorderDecorator contextToolBarBorderDec = new BorderDecorator(
				contextToolBar, BorderDecorator.TOPLEFT);
		...
		BorderDecorator borderDecorator = new BorderDecorator(contextBottomBar,
				BorderDecorator.BOTTOMLEFT);
