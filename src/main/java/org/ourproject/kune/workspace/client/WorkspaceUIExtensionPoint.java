...
public class WorkspaceUIExtensionPoint {
    public static final String CONTENT_TOOLBAR_RIGHT = "ws.entity.content.toolbar.right";
    ...
    public WorkspaceUIExtensionPoint(final String id, final CellPanel panel) {
        this.id = id;
        this.panel = panel;
    }
