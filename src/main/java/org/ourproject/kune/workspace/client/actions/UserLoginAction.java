...
public class UserLoginAction implements Action {
    ...
    public void execute(final Object value, final Object extra, final Services services) {
        onLogin(services, (UserCompleteDTO) value, (AsyncCallback) extra);
    }

    private void onLogin(final Services services, final UserCompleteDTO user, final AsyncCallback callback) {
