...
public class DocumentServiceDefault implements DocumentService {
    ...
    public ContentDTO getContent(final String userHash, final String ctxRef, final String docRef) {
    ...
    public String saveContent(final String userHash, final ContentDTO contentData) {
