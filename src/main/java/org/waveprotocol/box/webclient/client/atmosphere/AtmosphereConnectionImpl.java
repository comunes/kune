...
public class AtmosphereConnectionImpl implements AtmosphereConnection {
  ...
  private static final class AtmosphereSocket extends JavaScriptObject {
    public static native AtmosphereSocket create(AtmosphereConnectionImpl impl, String urlBase) /*-{
      ...
      var client = $wnd.atmosphere;
                ...
                atsocket.request.enableXDR = true;
                atsocket.request.readResponsesHeaders = false;
  ...
  public AtmosphereConnectionImpl(final AtmosphereConnectionListener listener,
  ...
  public void connect() {
    if (socket == null) {
      ...
      ScriptInjector.fromUrl( urlPrefix + "/atmosphere/atmosphere.js").setCallback(
   ...
   */
  @SuppressWarnings("unused")
  private void onDisconnect(final String response) {
