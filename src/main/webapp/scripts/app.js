...
(function (document) {
  ...
  kt.onSWInstalled = function () {
    console.log('Service worker installed. Caching complete! This app will work offline.');
  };

  kt.onSWError = function () {
  };

  kt.onSWUpdated = function () {
